...
import context
from day15 import Seeker, expand
...
def test_expanded_seek(sample_map):
    seeker = Seeker(expand(sample_map))
    length, _ = seeker.seek((0,0), (49,49))
    assert length == 315
